...
import 'package:todo_app/models/modeltask.dart';
import 'package:todo_app/utils/colors.dart';
import 'package:todo_app/utils/constant.dart';
import 'package:todo_app/utils/mystrings.dart';
import 'package:todo_app/views/home/homeview.dart';
import 'package:todo_app/database/hive_db.dart';
import 'package:todo_app/views/home/taskwidget.dart';
import 'package:todo_app/views/task/taskview.dart';
                    ...
                    children: [
                      ...
                      FadeIn(
                        child: SizedBox(
                          ...
                          height: 300,
                          child: Lottie.asset(
                            'assets/lottie/129405-splash-screen (1).json',
    ...
    return Container(
      ...
      child: Column(
        children: [
          const CircleAvatar(
            radius: 50,
            backgroundImage: AssetImage('assets/images/Login_withoutbg.png'),
          ),
          const SizedBox(
            height: 8,
          ),
          Text("Vishnu C", style: textTheme.headline2),
